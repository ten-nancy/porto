...
static void DefaultConfig() {
    ...
    config().mutable_container()->set_memory_high_limit_proportion(0);
    ...
    config().mutable_container()->set_enable_rw_net_cgroups(false);
    ...
    config().mutable_network()->set_container_qdisc("default: pfifo_fast");
    ...
    config().mutable_network()->set_bpf_progs_update_interval_ms(5000);
    ...
    config().mutable_network()->set_enable_netcls_classid(false);
