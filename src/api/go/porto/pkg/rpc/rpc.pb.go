...
import (
	seccomp "github.com/ten-nancy/porto/src/api/go/porto/pkg/seccomp"
...
const (
	...
	EError_InvalidFilesystem EError = 32
	// Negotiation with nbd server timed out
	EError_NbdSocketTimeout EError = 33
	// Failed connect to nbd server
	EError_NbdSocketUnavaliable EError = 34
	// Other nbd connection error
	EError_NbdSocketError EError = 35
	// Unkown nbd export
	EError_NbdUnkownExport EError = 36
	// Invalid message from nbd server
	EError_NbdProtoError     EError = 37
...
type TContainerRequest struct {
	...
	CleanupPlace         *TCleanupPlaceRequest          `protobuf:"bytes,307,opt,name=CleanupPlace" json:"CleanupPlace,omitempty"`
...
func (x *TContainerRequest) GetCleanupPlace() *TCleanupPlaceRequest {
	if x != nil {
		return x.CleanupPlace
	}
	return nil
}
...
type TCapabilities struct {
	...
	Action *bool    `protobuf:"varint,3,opt,name=action" json:"action,omitempty"` // in, null - rewrite, true - append, false - remove
}
...
func (x *TCapabilities) GetAction() bool {
...
type TContainerStatus struct {
	...
	CpuPressure                *TUintMap          `protobuf:"bytes,76,opt,name=cpu_pressure,json=cpuPressure" json:"cpu_pressure,omitempty"`                               // out
	...
	IoPressure                 *TUintMap          `protobuf:"bytes,351,opt,name=io_pressure,json=ioPressure" json:"io_pressure,omitempty"`                                 // out
	...
	MemoryPressure       *TUintMap              `protobuf:"bytes,83,opt,name=memory_pressure,json=memoryPressure" json:"memory_pressure,omitempty"` // out
	...
	NetLimitSoftStat     *TUintMap              `protobuf:"bytes,164,opt,name=net_limit_soft_stat,json=netLimitSoftStat" json:"net_limit_soft_stat,omitempty"` // out
	...
	NetLimitBound        *TUintMap              `protobuf:"bytes,500,opt,name=net_limit_bound,json=netLimitBound" json:"net_limit_bound,omitempty"`            // out
	NetRxLimitBound      *TUintMap              `protobuf:"bytes,501,opt,name=net_rx_limit_bound,json=netRxLimitBound" json:"net_rx_limit_bound,omitempty"`    // out
...
func (x *TContainerStatus) GetCpuPressure() *TUintMap {
	if x != nil {
...
func (x *TContainerStatus) GetIoPressure() *TUintMap {
	if x != nil {
		return x.IoPressure
	}
	return nil
...
func (x *TContainerStatus) GetMemoryPressure() *TUintMap {
	if x != nil {
...
func (x *TContainerStatus) GetNetLimitSoftStat() *TUintMap {
	if x != nil {
		return x.NetLimitSoftStat
	}
	return nil
}
...
func (x *TContainerStatus) GetNetLimitBound() *TUintMap {
	if x != nil {
		return x.NetLimitBound
	}
	return nil
}

func (x *TContainerStatus) GetNetRxLimitBound() *TUintMap {
	if x != nil {
		return x.NetRxLimitBound
	}
	return nil
}
...
type TContainerSpec struct {
	...
	EnableFuse          *bool                  `protobuf:"varint,91,opt,name=enable_fuse,json=enableFuse" json:"enable_fuse,omitempty"`
	...
	DevicesExplicit     *bool                  `protobuf:"varint,265,opt,name=devices_explicit,json=devicesExplicit" json:"devices_explicit,omitempty"`
	...
	IoGuarantee              *TUintMap              `protobuf:"bytes,84,opt,name=io_guarantee,json=ioGuarantee" json:"io_guarantee,omitempty"`              // bps
	IoOpsLimit               *TUintMap              `protobuf:"bytes,51,opt,name=io_ops_limit,json=ioOpsLimit" json:"io_ops_limit,omitempty"`               // iops
	IoOpsGuarantee           *TUintMap              `protobuf:"bytes,85,opt,name=io_ops_guarantee,json=ioOpsGuarantee" json:"io_ops_guarantee,omitempty"`   // iops
	...
	CoredumpFilter           *uint32                `protobuf:"varint,83,opt,name=coredump_filter,json=coredumpFilter" json:"coredump_filter,omitempty"`
	Seccomp                  *seccomp.TProfile      `protobuf:"bytes,86,opt,name=seccomp" json:"seccomp,omitempty"`
	SeccompName              *string                `protobuf:"bytes,87,opt,name=seccomp_name,json=seccompName" json:"seccomp_name,omitempty"`
	SessionInfo              *string                `protobuf:"bytes,88,opt,name=session_info,json=sessionInfo" json:"session_info,omitempty"`
	ChildrenAllowed          *bool                  `protobuf:"varint,92,opt,name=children_allowed,json=childrenAllowed" json:"children_allowed,omitempty"`
}
...
func (x *TContainerSpec) GetEnableFuse() bool {
	if x != nil && x.EnableFuse != nil {
		return *x.EnableFuse
	}
	return false
}
...
func (x *TContainerSpec) GetDevicesExplicit() bool {
	if x != nil && x.DevicesExplicit != nil {
		return *x.DevicesExplicit
	}
	return false
}
...
func (x *TContainerSpec) GetIoGuarantee() *TUintMap {
	if x != nil {
		return x.IoGuarantee
	}
	return nil
}
...
func (x *TContainerSpec) GetIoOpsGuarantee() *TUintMap {
	if x != nil {
		return x.IoOpsGuarantee
	}
	return nil
}
...
func (x *TContainerSpec) GetCoredumpFilter() uint32 {
	if x != nil && x.CoredumpFilter != nil {
		return *x.CoredumpFilter
	}
	return 0
}

func (x *TContainerSpec) GetSeccomp() *seccomp.TProfile {
	if x != nil {
		return x.Seccomp
	}
	return nil
...
func (x *TContainerSpec) GetSeccompName() string {
	if x != nil && x.SeccompName != nil {
		return *x.SeccompName
	}
	return ""
}

func (x *TContainerSpec) GetSessionInfo() string {
...
func (x *TContainerSpec) GetChildrenAllowed() bool {
	if x != nil && x.ChildrenAllowed != nil {
		return *x.ChildrenAllowed
	}
	return false
}
...
type TVolumeSpec struct {
	...
	FilesystemType *string        `protobuf:"bytes,15,opt,name=filesystem_type,json=filesystemType" json:"filesystem_type,omitempty"`
...
func (x *TVolumeSpec) GetFilesystemType() string {
...
type TUpdateFromSpecRequest struct {
	...
	Container *TContainerSpec `protobuf:"bytes,1,req,name=container" json:"container,omitempty"`
	Start     *bool           `protobuf:"varint,2,opt,name=start" json:"start,omitempty"`
}
...
func (x *TUpdateFromSpecRequest) GetStart() bool {
	if x != nil && x.Start != nil {
		return *x.Start
	}
	return false
...
type TVolumeListRequest struct {
	...
	Path         *string `protobuf:"bytes,1,opt,name=path" json:"path,omitempty"` // volume path or wildcard
...
type TLayerRemoveRequest struct {
	...
	Layer *string `protobuf:"bytes,1,req,name=layer" json:"layer,omitempty"`
	Place *string `protobuf:"bytes,2,opt,name=place" json:"place,omitempty"`
	Async *bool   `protobuf:"varint,3,opt,name=async" json:"async,omitempty"` // will be deprecated soon
}
...
type TCleanupPlaceRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TCleanupPlaceRequest) Reset() {
	*x = TCleanupPlaceRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TCleanupPlaceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TCleanupPlaceRequest) ProtoMessage() {}

func (x *TCleanupPlaceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[120]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TCleanupPlaceRequest.ProtoReflect.Descriptor instead.
func (*TCleanupPlaceRequest) Descriptor() ([]byte, []int) {
	return file_rpc_proto_rawDescGZIP(), []int{120}
}

func (x *TCleanupPlaceRequest) GetPlace() string {
	if x != nil && x.Place != nil {
		return *x.Place
	}
	return ""
...
type TDockerImageConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *TDockerImageConfig) Reset() {
	*x = TDockerImageConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *TDockerImageConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TDockerImageConfig) ProtoMessage() {}

func (x *TDockerImageConfig) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_proto_msgTypes[121]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TDockerImageConfig.ProtoReflect.Descriptor instead.
func (*TDockerImageConfig) Descriptor() ([]byte, []int) {
	return file_rpc_proto_rawDescGZIP(), []int{121}
}

func (x *TDockerImageConfig) GetCmd() []string {
	if x != nil {
		return x.Cmd
	}
	return nil
...
func (x *TDockerImageConfig) GetEnv() []string {
	if x != nil {
		return x.Env
	}
	return nil
...
type TDockerImage struct {
	...
	Digests []string            `protobuf:"bytes,3,rep,name=digests" json:"digests,omitempty"`
	Layers  []string            `protobuf:"bytes,4,rep,name=layers" json:"layers,omitempty"`
	Size    *uint64             `protobuf:"varint,5,opt,name=size" json:"size,omitempty"`
	Config  *TDockerImageConfig `protobuf:"bytes,6,opt,name=config" json:"config,omitempty"`
}
...
func (x *TDockerImage) GetId() string {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return ""
...
func (x *TDockerImage) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *TDockerImage) GetDigests() []string {
	if x != nil {
		return x.Digests
	}
	return nil
...
func (x *TDockerImage) GetSize() uint64 {
	if x != nil && x.Size != nil {
		return *x.Size
	}
	return 0
...
func (x *TDockerImage) GetConfig() *TDockerImageConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *TDockerImagePullRequest) GetPlatform() string {
...
var file_rpc_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x52, 0x0b, 0x73, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x12, 0x37,
	...
	0x47, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07,
	0x67, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x31, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x54, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x74, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x12, 0x2e, 0x0a, 0x04, 0x73, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65,
	...
	0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x2d, 0x0a, 0x12, 0x61, 0x62, 0x73, 0x6f,
	0x6c, 0x75, 0x74, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x61, 0x62, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x65, 0x4e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x72, 0x6f, 0x6f, 0x74, 0x5f,
	0x70, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x72, 0x6f, 0x6f, 0x74, 0x50,
	0x69, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x65, 0x78, 0x69, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x65, 0x78, 0x69, 0x74, 0x53, 0x74, 0x61,
	...
	,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x54, 0x45, 0x72,
	0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x3b, 0x0a, 0x0f, 0x54, 0x56,
	0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x12, 0x12, 0x0a,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xe6, 0x01, 0x0a, 0x12, 0x54, 0x56, 0x6f, 0x6c,
	0x75, 0x6d, 0x65, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12,
	0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61,
	0x74, 0x68, 0x12, 0x34, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x54, 0x56, 0x6f,
	0x6c, 0x75, 0x6d, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x52, 0x0a, 0x70, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x02, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x72, 0x69, 0x76, 0x61,
	0x74, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x8e, 0x03, 0x0a, 0x0c, 0x54, 0x4d, 0x65, 0x74,
	0x61, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x65, 0x73, 0x63, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09, 0x52, 0x04, 0x64, 0x65, 0x73, 0x63,
	...
	0x07, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07,
	0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x22, 0x1b, 0x0a, 0x19, 0x54, 0x43, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x22, 0xac, 0x01, 0x0a, 0x1a, 0x54, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	0x6e, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x4b, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28,
	...
	0x61, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74,
	0x1a, 0x41, 0x0a, 0x17, 0x54, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x44, 0x61,
	0x74, 0x61, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x02, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x12, 0x0a, 0x04, 0x64, 0x65, 0x73, 0x63, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09, 0x52, 0x04, 0x64,
	0x65, 0x73, 0x63, 0x22, 0x2d, 0x0a, 0x17, 0x54, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65,
	...
	,
	...
	0x6d, 0x65, 0x22, 0x76, 0x0a, 0x1c, 0x54, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72,
	...
	,
	...
	0x22, 0x64, 0x0a, 0x1c, 0x54, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x65,
	...
	,
	...
	,
	...
	0x12, 0x12, 0x0a, 0x04, 0x77, 0x68, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04,
	0x77, 0x68, 0x65, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x04, 0x20,
	...
	,
	...
	,
	...
	0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c,
	0x61, 0x62, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65,
	0x6c, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x02, 0x28, 0x09,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x10, 0x54, 0x53, 0x65, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x22, 0x57, 0x0a, 0x13,
	0x54, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x18, 0x01, 0x20, 0x02,
	0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6c, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x03, 0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x69, 0x67,
	0x65, 0x73, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x64, 0x69, 0x67, 0x65,
	0x73, 0x74, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x06, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x73,
	...
	0x17, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x54, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x49, 0x6d, 0x61,
	0x67, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x22, 0x45, 0x0a, 0x19, 0x54, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x52, 0x05, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x22, 0x45, 0x0a, 0x1a, 0x54, 0x44, 0x6f, 0x63, 0x6b,
	0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x54, 0x44, 0x6f, 0x63, 0x6b,
	0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x43,
	0x0a, 0x17, 0x54, 0x44, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6c, 0x61,
	...
	,
	...
	,
	...
	,
}
...
var file_rpc_proto_goTypes = []interface{}{
	...
	(*TCleanupPlaceRequest)(nil),                                       // 121: rpc.TCleanupPlaceRequest
	(*TDockerImageConfig)(nil),                                         // 122: rpc.TDockerImageConfig
	(*TDockerImage)(nil),                                               // 123: rpc.TDockerImage
	(*TDockerImageStatusRequest)(nil),                                  // 124: rpc.TDockerImageStatusRequest
	(*TDockerImageStatusResponse)(nil),                                 // 125: rpc.TDockerImageStatusResponse
	(*TDockerImageListRequest)(nil),                                    // 126: rpc.TDockerImageListRequest
	(*TDockerImageListResponse)(nil),                                   // 127: rpc.TDockerImageListResponse
	(*TDockerImagePullRequest)(nil),                                    // 128: rpc.TDockerImagePullRequest
	(*TDockerImagePullResponse)(nil),                                   // 129: rpc.TDockerImagePullResponse
	(*TDockerImageRemoveRequest)(nil),                                  // 130: rpc.TDockerImageRemoveRequest
	(*TStringMap_TStringMapEntry)(nil),                                 // 131: rpc.TStringMap.TStringMapEntry
	(*TUintMap_TUintMapEntry)(nil),                                     // 132: rpc.TUintMap.TUintMapEntry
	(*TContainerIpConfig_TContainerIp)(nil),                            // 133: rpc.TContainerIpConfig.TContainerIp
	(*TContainerPropertyListResponse_TContainerPropertyListEntry)(nil), // 134: rpc.TContainerPropertyListResponse.TContainerPropertyListEntry
	(*TContainerDataListResponse_TContainerDataListEntry)(nil),         // 135: rpc.TContainerDataListResponse.TContainerDataListEntry
	(*TContainerGetResponse_TContainerGetValueResponse)(nil),           // 136: rpc.TContainerGetResponse.TContainerGetValueResponse
	(*TContainerGetResponse_TContainerGetListResponse)(nil),            // 137: rpc.TContainerGetResponse.TContainerGetListResponse
	(*TFindLabelResponse_TFindLabelEntry)(nil),                         // 138: rpc.TFindLabelResponse.TFindLabelEntry
	(*TVolumePropertyListResponse_TVolumePropertyDescription)(nil),     // 139: rpc.TVolumePropertyListResponse.TVolumePropertyDescription
	(*seccomp.TProfile)(nil),                                           // 140: seccomp.TProfile
}
var file_rpc_proto_depIdxs = []int32{
	...
	121, // 45: rpc.TContainerRequest.CleanupPlace:type_name -> rpc.TCleanupPlaceRequest
	44,  // 46: rpc.TContainerRequest.CreateMetaStorage:type_name -> rpc.TMetaStorage
	44,  // 47: rpc.TContainerRequest.ResizeMetaStorage:type_name -> rpc.TMetaStorage
	44,  // 48: rpc.TContainerRequest.RemoveMetaStorage:type_name -> rpc.TMetaStorage
	93,  // 49: rpc.TContainerRequest.SetSymlink:type_name -> rpc.TSetSymlinkRequest
	94,  // 50: rpc.TContainerRequest.NewVolume:type_name -> rpc.TNewVolumeRequest
	96,  // 51: rpc.TContainerRequest.GetVolume:type_name -> rpc.TGetVolumeRequest
	79,  // 52: rpc.TContainerRequest.convertPath:type_name -> rpc.TConvertPathRequest
	84,  // 53: rpc.TContainerRequest.attachProcess:type_name -> rpc.TAttachProcessRequest
	85,  // 54: rpc.TContainerRequest.locateProcess:type_name -> rpc.TLocateProcessRequest
	84,  // 55: rpc.TContainerRequest.AttachThread:type_name -> rpc.TAttachProcessRequest
	47,  // 56: rpc.TContainerRequest.GetSystem:type_name -> rpc.TGetSystemRequest
	50,  // 57: rpc.TContainerRequest.SetSystem:type_name -> rpc.TSetSystemRequest
	48,  // 58: rpc.TContainerRequest.ClearStatistics:type_name -> rpc.TClearStatisticsRequest
	124, // 59: rpc.TContainerRequest.dockerImageStatus:type_name -> rpc.TDockerImageStatusRequest
	126, // 60: rpc.TContainerRequest.listDockerImages:type_name -> rpc.TDockerImageListRequest
	128, // 61: rpc.TContainerRequest.pullDockerImage:type_name -> rpc.TDockerImagePullRequest
	130, // 62: rpc.TContainerRequest.removeDockerImage:type_name -> rpc.TDockerImageRemoveRequest
	0,   // 63: rpc.TContainerResponse.error:type_name -> rpc.EError
	66,  // 64: rpc.TContainerResponse.list:type_name -> rpc.TContainerListResponse
	68,  // 65: rpc.TContainerResponse.getProperty:type_name -> rpc.TContainerGetPropertyResponse
	70,  // 66: rpc.TContainerResponse.getData:type_name -> rpc.TContainerGetDataResponse
	60,  // 67: rpc.TContainerResponse.propertyList:type_name -> rpc.TContainerPropertyListResponse
	62,  // 68: rpc.TContainerResponse.dataList:type_name -> rpc.TContainerDataListResponse
	46,  // 69: rpc.TContainerResponse.version:type_name -> rpc.TVersionResponse
	104, // 70: rpc.TContainerResponse.volumeList:type_name -> rpc.TVolumeListResponse
	73,  // 71: rpc.TContainerResponse.get:type_name -> rpc.TContainerGetResponse
	82,  // 72: rpc.TContainerResponse.wait:type_name -> rpc.TContainerWaitResponse
	99,  // 73: rpc.TContainerResponse.volumePropertyList:type_name -> rpc.TVolumePropertyListResponse
	35,  // 74: rpc.TContainerResponse.volumeDescription:type_name -> rpc.TVolumeDescription
	109, // 75: rpc.TContainerResponse.layers:type_name -> rpc.TLayerListResponse
	80,  // 76: rpc.TContainerResponse.convertPath:type_name -> rpc.TConvertPathResponse
	114, // 77: rpc.TContainerResponse.layer_private:type_name -> rpc.TLayerGetPrivateResponse
	117, // 78: rpc.TContainerResponse.storageList:type_name -> rpc.TStorageListResponse
	86,  // 79: rpc.TContainerResponse.locateProcess:type_name -> rpc.TLocateProcessResponse
	82,  // 80: rpc.TContainerResponse.AsyncWait:type_name -> rpc.TContainerWaitResponse
	88,  // 81: rpc.TContainerResponse.FindLabel:type_name -> rpc.TFindLabelResponse
	90,  // 82: rpc.TContainerResponse.SetLabel:type_name -> rpc.TSetLabelResponse
	92,  // 83: rpc.TContainerResponse.IncLabel:type_name -> rpc.TIncLabelResponse
	107, // 84: rpc.TContainerResponse.checkVolume:type_name -> rpc.TVolumeCheckResponse
	58,  // 85: rpc.TContainerResponse.ListContainersBy:type_name -> rpc.TListContainersResponse
	95,  // 86: rpc.TContainerResponse.NewVolume:type_name -> rpc.TNewVolumeResponse
	97,  // 87: rpc.TContainerResponse.GetVolume:type_name -> rpc.TGetVolumeResponse
	49,  // 88: rpc.TContainerResponse.GetSystem:type_name -> rpc.TGetSystemResponse
	51,  // 89: rpc.TContainerResponse.SetSystem:type_name -> rpc.TSetSystemResponse
	125, // 90: rpc.TContainerResponse.dockerImageStatus:type_name -> rpc.TDockerImageStatusResponse
	127, // 91: rpc.TContainerResponse.listDockerImages:type_name -> rpc.TDockerImageListResponse
	129, // 92: rpc.TContainerResponse.pullDockerImage:type_name -> rpc.TDockerImagePullResponse
	131, // 93: rpc.TStringMap.map:type_name -> rpc.TStringMap.TStringMapEntry
	132, // 94: rpc.TUintMap.map:type_name -> rpc.TUintMap.TUintMapEntry
	0,   // 95: rpc.TError.error:type_name -> rpc.EError
	9,   // 96: rpc.TContainerEnv.var:type_name -> rpc.TContainerEnvVar
	11,  // 97: rpc.TContainerUlimits.ulimit:type_name -> rpc.TContainerUlimit
	14,  // 98: rpc.TContainerCgroups.cgroup:type_name -> rpc.TContainerCgroup
	17,  // 99: rpc.TContainerBindMounts.bind:type_name -> rpc.TContainerBindMount
	19,  // 100: rpc.TContainerVolumeLinks.link:type_name -> rpc.TContainerVolumeLink
	22,  // 101: rpc.TContainerPlaceConfig.cfg:type_name -> rpc.TContainerPlace
	24,  // 102: rpc.TContainerDevices.device:type_name -> rpc.TContainerDevice
	26,  // 103: rpc.TContainerNetConfig.cfg:type_name -> rpc.TContainerNetOption
	133, // 104: rpc.TContainerIpConfig.cfg:type_name -> rpc.TContainerIpConfig.TContainerIp
	5,   // 105: rpc.TContainerStatus.start_error:type_name -> rpc.TError
	7,   // 106: rpc.TContainerStatus.capabilities_allowed:type_name -> rpc.TCapabilities
	7,   // 107: rpc.TContainerStatus.capabilities_ambient_allowed:type_name -> rpc.TCapabilities
	15,  // 108: rpc.TContainerStatus.cgroups:type_name -> rpc.TContainerCgroups
	16,  // 109: rpc.TContainerStatus.cpu_set_affinity:type_name -> rpc.TContainerCpuSet
	4,   // 110: rpc.TContainerStatus.cpu_pressure:type_name -> rpc.TUintMap
	4,   // 111: rpc.TContainerStatus.io_read:type_name -> rpc.TUintMap
	4,   // 112: rpc.TContainerStatus.io_write:type_name -> rpc.TUintMap
	4,   // 113: rpc.TContainerStatus.io_ops:type_name -> rpc.TUintMap
	4,   // 114: rpc.TContainerStatus.io_read_ops:type_name -> rpc.TUintMap
	4,   // 115: rpc.TContainerStatus.io_write_ops:type_name -> rpc.TUintMap
	4,   // 116: rpc.TContainerStatus.io_time:type_name -> rpc.TUintMap
	4,   // 117: rpc.TContainerStatus.io_pressure:type_name -> rpc.TUintMap
	4,   // 118: rpc.TContainerStatus.place_usage:type_name -> rpc.TUintMap
	4,   // 119: rpc.TContainerStatus.memory_pressure:type_name -> rpc.TUintMap
	30,  // 120: rpc.TContainerStatus.virtual_memory:type_name -> rpc.TVmStat
	4,   // 121: rpc.TContainerStatus.net_bytes:type_name -> rpc.TUintMap
	4,   // 122: rpc.TContainerStatus.net_packets:type_name -> rpc.TUintMap
	4,   // 123: rpc.TContainerStatus.net_drops:type_name -> rpc.TUintMap
	4,   // 124: rpc.TContainerStatus.net_overlimits:type_name -> rpc.TUintMap
	4,   // 125: rpc.TContainerStatus.net_rx_bytes:type_name -> rpc.TUintMap
	4,   // 126: rpc.TContainerStatus.net_rx_packets:type_name -> rpc.TUintMap
	4,   // 127: rpc.TContainerStatus.net_rx_drops:type_name -> rpc.TUintMap
	4,   // 128: rpc.TContainerStatus.net_rx_overlimits:type_name -> rpc.TUintMap
	4,   // 129: rpc.TContainerStatus.net_tx_bytes:type_name -> rpc.TUintMap
	4,   // 130: rpc.TContainerStatus.net_tx_packets:type_name -> rpc.TUintMap
	4,   // 131: rpc.TContainerStatus.net_tx_drops:type_name -> rpc.TUintMap
	4,   // 132: rpc.TContainerStatus.net_limit_soft_stat:type_name -> rpc.TUintMap
	4,   // 133: rpc.TContainerStatus.net_netstat:type_name -> rpc.TUintMap
	4,   // 134: rpc.TContainerStatus.net_snmp:type_name -> rpc.TUintMap
	4,   // 135: rpc.TContainerStatus.net_snmp6:type_name -> rpc.TUintMap
	4,   // 136: rpc.TContainerStatus.net_limit_bound:type_name -> rpc.TUintMap
	4,   // 137: rpc.TContainerStatus.net_rx_limit_bound:type_name -> rpc.TUintMap
	20,  // 138: rpc.TContainerStatus.volumes_linked:type_name -> rpc.TContainerVolumeLinks
	21,  // 139: rpc.TContainerStatus.volumes_owned:type_name -> rpc.TContainerVolumes
	5,   // 140: rpc.TContainerStatus.error:type_name -> rpc.TError
	5,   // 141: rpc.TContainerStatus.warning:type_name -> rpc.TError
	5,   // 142: rpc.TContainerStatus.taint:type_name -> rpc.TError
	3,   // 143: rpc.TContainerSpec.labels:type_name -> rpc.TStringMap
	8,   // 144: rpc.TContainerSpec.command_argv:type_name -> rpc.TContainerCommandArgv
	10,  // 145: rpc.TContainerSpec.env:type_name -> rpc.TContainerEnv
	10,  // 146: rpc.TContainerSpec.env_secret:type_name -> rpc.TContainerEnv
	12,  // 147: rpc.TContainerSpec.ulimit:type_name -> rpc.TContainerUlimits
	6,   // 148: rpc.TContainerSpec.task_cred:type_name -> rpc.TCred
	6,   // 149: rpc.TContainerSpec.owner_cred:type_name -> rpc.TCred
	7,   // 150: rpc.TContainerSpec.capabilities:type_name -> rpc.TCapabilities
	7,   // 151: rpc.TContainerSpec.capabilities_ambient:type_name -> rpc.TCapabilities
	18,  // 152: rpc.TContainerSpec.bind:type_name -> rpc.TContainerBindMounts
	3,   // 153: rpc.TContainerSpec.symlink:type_name -> rpc.TStringMap
	25,  // 154: rpc.TContainerSpec.devices:type_name -> rpc.TContainerDevices
	23,  // 155: rpc.TContainerSpec.place:type_name -> rpc.TContainerPlaceConfig
	4,   // 156: rpc.TContainerSpec.place_limit:type_name -> rpc.TUintMap
	13,  // 157: rpc.TContainerSpec.controllers:type_name -> rpc.TContainerControllers
	16,  // 158: rpc.TContainerSpec.cpu_set:type_name -> rpc.TContainerCpuSet
	4,   // 159: rpc.TContainerSpec.io_limit:type_name -> rpc.TUintMap
	4,   // 160: rpc.TContainerSpec.io_guarantee:type_name -> rpc.TUintMap
	4,   // 161: rpc.TContainerSpec.io_ops_limit:type_name -> rpc.TUintMap
	4,   // 162: rpc.TContainerSpec.io_ops_guarantee:type_name -> rpc.TUintMap
	27,  // 163: rpc.TContainerSpec.net:type_name -> rpc.TContainerNetConfig
	28,  // 164: rpc.TContainerSpec.ip_limit:type_name -> rpc.TContainerIpLimit
	29,  // 165: rpc.TContainerSpec.ip:type_name -> rpc.TContainerIpConfig
	29,  // 166: rpc.TContainerSpec.default_gw:type_name -> rpc.TContainerIpConfig
	3,   // 167: rpc.TContainerSpec.sysctl:type_name -> rpc.TStringMap
	4,   // 168: rpc.TContainerSpec.net_guarantee:type_name -> rpc.TUintMap
	4,   // 169: rpc.TContainerSpec.net_limit:type_name -> rpc.TUintMap
	4,   // 170: rpc.TContainerSpec.net_rx_limit:type_name -> rpc.TUintMap
	21,  // 171: rpc.TContainerSpec.volumes_required:type_name -> rpc.TContainerVolumes
	140, // 172: rpc.TContainerSpec.seccomp:type_name -> seccomp.TProfile
	32,  // 173: rpc.TContainer.spec:type_name -> rpc.TContainerSpec
	31,  // 174: rpc.TContainer.status:type_name -> rpc.TContainerStatus
	5,   // 175: rpc.TContainer.error:type_name -> rpc.TError
	34,  // 176: rpc.TVolumeDescription.properties:type_name -> rpc.TVolumeProperty
	36,  // 177: rpc.TVolumeDescription.links:type_name -> rpc.TVolumeLink
	6,   // 178: rpc.TVolumeDirectory.cred:type_name -> rpc.TCred
	36,  // 179: rpc.TVolumeSpec.links:type_name -> rpc.TVolumeLink
	6,   // 180: rpc.TVolumeSpec.cred:type_name -> rpc.TCred
	37,  // 181: rpc.TVolumeSpec.space:type_name -> rpc.TVolumeResource
	37,  // 182: rpc.TVolumeSpec.inodes:type_name -> rpc.TVolumeResource
	6,   // 183: rpc.TVolumeSpec.owner:type_name -> rpc.TCred
	38,  // 184: rpc.TVolumeSpec.directories:type_name -> rpc.TVolumeDirectory
	39,  // 185: rpc.TVolumeSpec.symlinks:type_name -> rpc.TVolumeSymlink
	40,  // 186: rpc.TVolumeSpec.shares:type_name -> rpc.TVolumeShare
	32,  // 187: rpc.TCreateFromSpecRequest.container:type_name -> rpc.TContainerSpec
	41,  // 188: rpc.TCreateFromSpecRequest.volumes:type_name -> rpc.TVolumeSpec
	32,  // 189: rpc.TUpdateFromSpecRequest.container:type_name -> rpc.TContainerSpec
	3,   // 190: rpc.TListContainersFilter.labels:type_name -> rpc.TStringMap
	55,  // 191: rpc.TListContainersFieldOptions.stdout_options:type_name -> rpc.TStreamDumpOptions
	55,  // 192: rpc.TListContainersFieldOptions.stderr_options:type_name -> rpc.TStreamDumpOptions
	54,  // 193: rpc.TListContainersRequest.filters:type_name -> rpc.TListContainersFilter
	56,  // 194: rpc.TListContainersRequest.field_options:type_name -> rpc.TListContainersFieldOptions
	33,  // 195: rpc.TListContainersResponse.containers:type_name -> rpc.TContainer
	134, // 196: rpc.TContainerPropertyListResponse.list:type_name -> rpc.TContainerPropertyListResponse.TContainerPropertyListEntry
	135, // 197: rpc.TContainerDataListResponse.list:type_name -> rpc.TContainerDataListResponse.TContainerDataListEntry
	137, // 198: rpc.TContainerGetResponse.list:type_name -> rpc.TContainerGetResponse.TContainerGetListResponse
	138, // 199: rpc.TFindLabelResponse.list:type_name -> rpc.TFindLabelResponse.TFindLabelEntry
	41,  // 200: rpc.TNewVolumeRequest.volume:type_name -> rpc.TVolumeSpec
	41,  // 201: rpc.TNewVolumeResponse.volume:type_name -> rpc.TVolumeSpec
	41,  // 202: rpc.TGetVolumeResponse.volume:type_name -> rpc.TVolumeSpec
	139, // 203: rpc.TVolumePropertyListResponse.properties:type_name -> rpc.TVolumePropertyListResponse.TVolumePropertyDescription
	34,  // 204: rpc.TVolumeCreateRequest.properties:type_name -> rpc.TVolumeProperty
	35,  // 205: rpc.TVolumeListResponse.volumes:type_name -> rpc.TVolumeDescription
	34,  // 206: rpc.TVolumeTuneRequest.properties:type_name -> rpc.TVolumeProperty
	42,  // 207: rpc.TLayerListResponse.layers:type_name -> rpc.TLayerDescription
	43,  // 208: rpc.TStorageListResponse.storages:type_name -> rpc.TStorageDescription
	44,  // 209: rpc.TStorageListResponse.meta_storages:type_name -> rpc.TMetaStorage
	122, // 210: rpc.TDockerImage.config:type_name -> rpc.TDockerImageConfig
	123, // 211: rpc.TDockerImageStatusResponse.image:type_name -> rpc.TDockerImage
	123, // 212: rpc.TDockerImageListResponse.images:type_name -> rpc.TDockerImage
	123, // 213: rpc.TDockerImagePullResponse.image:type_name -> rpc.TDockerImage
	0,   // 214: rpc.TContainerGetResponse.TContainerGetValueResponse.error:type_name -> rpc.EError
	136, // 215: rpc.TContainerGetResponse.TContainerGetListResponse.keyval:type_name -> rpc.TContainerGetResponse.TContainerGetValueResponse
...
func file_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_proto_msgTypes[120].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TCleanupPlaceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rpc_proto_msgTypes[121].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TDockerImageConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
