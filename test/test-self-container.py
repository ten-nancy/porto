...
ExpectEq(subprocess.check_output([portoctl, 'exec', 'test', 'command=' + portoctl + ' get self absolute_name'],
                                stdin=subprocess.PIPE, stderr=subprocess.PIPE), b'/porto/test\n')
...
ExpectEq(subprocess.check_output([portoctl, 'exec', 'test', 'porto_namespace=',
                                ...
                                stdin=subprocess.PIPE, stderr=subprocess.PIPE), b'/porto/test/test\n')
...
try:
	...
	ExpectEq(subprocess.check_output([portoctl, 'exec', 'test', 'porto_namespace=',
                                ...
                                stdin=subprocess.PIPE, stderr=subprocess.PIPE), b'self\n')
